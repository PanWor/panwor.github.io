...
function languageEmojiTitle(projectLang, langUsed) {
    if (langUsed=== 'pl') {
        ...
        if (projectLang === 'pl') {
            ...
            return 'This project is in English and Polish';
        } else {
        ...
        sortedProjects.forEach(project => {
          ...
          projectsContainer.innerHTML += `
            <div class="project-card">
                ...
                ${pcCompatibility ? `<img class="compatibility" src="${imagesSource}pc.svg" alt="${button['pc']}" title="${button['pc']}">` : ``}
                ${mobileCompatibility ? `<img class="compatibility mobile" src="${imagesSource}mobile.svg" alt="${button['mobile']}" title="${button['mobile']}">` : ``}
            </div>
                      `
