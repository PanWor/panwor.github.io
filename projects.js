        ...
        sortedProjects.forEach(project => {
          ...
          projectsContainer.innerHTML += `
            <div class="project-card">
                ...
                ${pcCompatibility ? `<img class="compatibility" src="${imagesSource}pc.svg" alt="${pc}" title="${pc}">` : ``}
                ${mobileCompatibility ? `<img class="compatibility mobile" src="${imagesSource}mobile.svg" alt="${mobile}" title="${mobile}">` : ``}
            </div>
                      `
